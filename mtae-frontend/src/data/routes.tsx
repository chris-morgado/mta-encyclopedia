...
function preprocessRoutes(raw: RouteGeoJson): RouteGeoJson {    
    ...
    // This preprocessing assigns offsets based on route names (it's not perfect, since stretches like the J and Z don't need to be offsetted, but this shit is really hard to do).
